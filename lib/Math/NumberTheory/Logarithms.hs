...
-- Copyright:   (c) 2011 Daniel Fischer, 2017 Oleg Grenrus, 2025 konsumlamm
-- Licence:     MIT
-- Stability:   Provisional
-- Portability: Non-portable (MicroHs)
--
-- Integer Logarithms.
module Math.NumberTheory.Logarithms
...
wordLog2 :: Word -> Int
wordLog2 w
  | w == 0      = error "Math.NumberTheory.Logarithms.wordLog2: argument must not be 0."
  | otherwise   = wordLog2' w
...
--   called often for known good input.
intLog2' :: Int -> Int
intLog2' i = wordLog2' (primIntToWord i)
...
naturalLog10 n
  | n < 1     = error "Math.NumberTheory.Logarithms.naturalLog10: argument must be non-zero"
...
unsafeAt :: UArr Int -> Int -> Int
unsafeAt = unsafeReadUArr
