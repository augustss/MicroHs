...
#endif
counter_t red_bb, red_k4, red_k3, red_k2, red_ccb, red_z, red_r, red_sk, red_bk, red_ck, red_sk2, red_cc;
...
MAIN
{
  ...
  if (verbose) {
    ...
    PRINT(" GC reductions A=%"PRIcounter", K=%"PRIcounter", I=%"PRIcounter", int=%"PRIcounter" flip=%"PRIcounter"\n",
          red_a, red_k, red_i, red_int, red_flip);
    PRINT(" special reductions B'=%"PRIcounter" K4=%"PRIcounter" K3=%"PRIcounter" K2=%"PRIcounter" C'B=%"PRIcounter", Z=%"PRIcounter", R=%"PRIcounter" SK=%"PRIcounter" BK=%"PRIcounter" SK2=%"PRIcounter" CK=%"PRIcounter" CC=%"PRIcounter"\n",
